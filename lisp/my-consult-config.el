...
;; scroll over the list of candidates while doing preview.       
(define-key selectrum-minibuffer-map [S-up] #'selectrum-previous)
(define-key selectrum-minibuffer-map [S-down] #'selectrum-next)
